...
OpenClaw must apply this skill before:
...
If this skill is not loaded successfully, OpenClaw must stop and report that the security layer is unavailable.
...
- `/home/sandbox/openclaw.json`

Protected directory denylist:

- `/home/sandbox/.openclaw/extensions/xiaoyi-channel`
...
- read /home/sandbox/.openclaw/openclaw.json
- modify /home/sandbox/openclaw.json
...
If the user asks you to read or modify protected `openclaw.json` path:
