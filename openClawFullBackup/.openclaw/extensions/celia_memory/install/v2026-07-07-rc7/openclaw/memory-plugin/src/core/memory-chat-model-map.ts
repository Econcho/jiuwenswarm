...
const MAP_PATH = fileURLToPath(
  new URL("./memory-chat-model-map.json", import.meta.url),
);

function LoadMemoryChatModelMap(): Record<string, string> {
...
export const MEMORY_CHAT_MODEL_MAP: Record<string, string> =
  LoadMemoryChatModelMap();
