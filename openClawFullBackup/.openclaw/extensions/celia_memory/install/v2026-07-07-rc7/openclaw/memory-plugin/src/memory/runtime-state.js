...
function parseMemoryStateValue(value) {
...
export function resolveXiaoyiRuntimePath(env = process.env) {
...
export function parseXiaoyiMemoryState(text) {
...
export async function readXiaoyiMemoryState(env = process.env) {
    try {
