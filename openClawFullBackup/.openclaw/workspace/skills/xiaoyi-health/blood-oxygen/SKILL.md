...
### 获取今日血氧
```bash
./skills/xiaoyi-health/bin/pha-claw get_spo2 --date today
```

### 获取指定日期血氧
```bash
./skills/xiaoyi-health/bin/pha-claw get_spo2 --date 2024-01-15
```

### 获取最近 7 天血氧趋势
```bash
./skills/xiaoyi-health/bin/pha-claw get_spo2 --last-days 7
```

### 获取最近 30 天血氧趋势
```bash
./skills/xiaoyi-health/bin/pha-claw get_spo2 --last-days 30
```

### 获取指定日期范围血氧
```bash
./skills/xiaoyi-health/bin/pha-claw get_spo2 --start-date 2024-01-01 --end-date 2024-01-31
```
