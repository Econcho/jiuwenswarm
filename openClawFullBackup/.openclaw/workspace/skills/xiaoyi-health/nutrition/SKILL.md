...
### 获取今日营养摄入（单日）
```bash
./skills/xiaoyi-health/bin/pha-claw get_nutrition --date today
```

### 获取指定日期营养数据（单日）
```bash
./skills/xiaoyi-health/bin/pha-claw get_nutrition --date 2024-01-15
```

### 获取指定日期范围饮食汇总（范围查询，推荐）
```bash
./skills/xiaoyi-health/bin/pha-claw get_diet_log_period --start-date 2024-01-01 --end-date 2024-01-07
```

### 获取最近 7 天饮食汇总
```bash
./skills/xiaoyi-health/bin/pha-claw get_diet_log_period --start-date 2024-01-09 --end-date 2024-01-15
```

### 获取最近 30 天饮食汇总
```bash
./skills/xiaoyi-health/bin/pha-claw get_diet_log_period --start-date 2023-12-16 --end-date 2024-01-15
```
