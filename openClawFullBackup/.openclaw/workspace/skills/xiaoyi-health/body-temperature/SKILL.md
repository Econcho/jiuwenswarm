...
metadata:
  {
    "pha": {
      ...
      "requires": { "tools": ["get_body_temperature"] }
    }
  }
---
...
### 获取今日体温
```bash
./skills/xiaoyi-health/bin/pha-claw get_body_temperature --date today
```

### 获取指定日期体温
```bash
./skills/xiaoyi-health/bin/pha-claw get_body_temperature --date 2024-01-15
```

### 获取最近 7 天体温趋势
```bash
./skills/xiaoyi-health/bin/pha-claw get_body_temperature --last-days 7
```

### 获取最近 30 天体温趋势
```bash
./skills/xiaoyi-health/bin/pha-claw get_body_temperature --last-days 30
```

### 获取指定日期范围体温数据
```bash
./skills/xiaoyi-health/bin/pha-claw get_body_temperature --start-date 2024-01-01 --end-date 2024-01-31
```
